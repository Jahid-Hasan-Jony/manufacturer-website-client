        ...
        <div>
            <div className="hero min-h-screen bg-lime-50">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div>
                        <h1 className="text-5xl font-bold">Welcome To JN Industries Ltd!</h1>
                        <p className="py-6 w-3/5 text-md ">We provide a wide range of lubricating equipment that can be used in industrial, commercial, and household works.</p>
